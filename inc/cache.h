...
#define OFFSET_MASK 0x0000000f //block offset mask, 16 words = f, 4 words = 3, 1 word = 0
...
#define I_INDEX 2 //block index, 16 words = 0, 4 words = 2, 1 word = 4
#define I_OFFSET 4 //block offset, 16 words = 4, 4 words = 2, 1 word = 0
#define I_BLOCK_MASK 0x00000003 //16 words = 0, 4 words = 3, 1 word = f

/*Block size word alligned*/
#define D_INDEX 1  //block index, 16 words = 1, 4 words = 4, 1 word = 16
#define D_OFFSET 4 //block offset, 16 words = 4, 4 words = 2, 1 word = 0
#define D_BLOCK_MASK 0x0000001 //16 words = 0, 4 words = 3, 1 word = f
